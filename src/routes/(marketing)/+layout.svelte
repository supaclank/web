  ...
  >
    <div class="mx-auto flex h-16 w-full max-w-5xl items-center justify-between px-5">
      ...
      <div class="flex items-center gap-1 text-sm sm:gap-2">
        <!-- TODO(ai-review): share the Discord/X/GitHub URLs from one module instead of repeating them here and in the mobile menu https://github.com/supaclank/web/pull/20#discussion_r3823080318 -->
        <div class="hidden items-center gap-1 sm:flex">
          <a
            ...
            rel="noreferrer"
            aria-label="Discord"
            class="inline-flex h-6 w-6 items-center justify-center text-muted transition-colors hover:text-ink"
          >
          ...
          <span class="ml-1 h-4 w-px bg-line-subtle"></span>
        </div>
        {#if signedIn}
          <a
            href="/welcome"
