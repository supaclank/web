          ...
          <div class="relative h-[500px] w-[236px] overflow-hidden">
            ...
            >
              <div class="flex h-full w-full flex-col items-center justify-center gap-3 bg-paper px-4 text-center">
                <!-- This mimics an install prompt, so show the real app icon
                     (the scene with its sky) rather than the transparent sprite. -->
                <img src="/app-icon.png" alt="" class="h-14 w-14 rounded-2xl shadow-sm ring-1 ring-black/5" />
                <div>
